        ...
        app.put("/update-about/:id", async (req, res) => {
            ...
            const updatedDoc = {
                $set: {
                    ...
                    pointFour: aboutSection.pointFour,
                    pointFive: aboutSection.pointFive,
...
app.get('/', (req, res) => {
    res.send('Good Job, SEO-18 Server is Working Fine');
});

app.listen(port, () => {
    console.log('Good Job, SEO-18 Server is Live Now', port);
});